                    ...
                    <tbody class="list form-check-all">
                        ...
                        @foreach ($orders as $order)
                            ...
                            <tr>
                                ...
                                <td class="status"><span class="badge badge-soft-success text-uppercase">{{ $order->status_pengerjaan->nama }}</span></td>
                                <td>
                                    <div class="d-flex gap-2">
                                        <div class="edit">
                                            {{-- <button class="btn btn-sm btn-success edit-item-btn"
                                            data-bs-toggle="modal" data-bs-target="#showModal">Edit</button> --}}
                                                <a href="/order/{{ $order->id }}/edit" class="btn btn-sm btn-success edit-item-btn" >Edit</a>
                                        </div>
                                        {{-- <div class="remove">
