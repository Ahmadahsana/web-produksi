...
<div class="card">
    <div class="card-header">
        <h4 class="card-title mb-0">List Sales</h4>
    </div><!-- end card header -->
                    ...
                    <tbody class="list form-check-all">
                        @foreach ($sales as $s)
                            <tr>
                                ...
                                <td class="status"><span class="badge  @if ($s->status_sales==1) badge-soft-success @else badge-soft-danger @endif text-uppercase">@if ($s->status_sales==1) Active @else NonActive @endif</span></td>
                                <td>
                                    <div class="d-flex gap-2">
                                        <div class="edit">
                                                <a href="/sales_show/{{ $s->id }}" class="btn btn-sm btn-success edit-item-btn">Detail</a>
                                        </div>
                                        <div class="remove">
