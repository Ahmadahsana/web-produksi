                    ...
                    <div class="col">
                        <div class="p-2">
                            ...
                            <div class="hstack text-white-50 gap-1">
                                <div class="me-2"><i
                                        class="ri-map-pin-user-line me-1 text-white-75 fs-16 align-middle"></i>{{ $sales->city->city_name }},
                                        {{ $sales->province->prov_name }}</div>
                                <div><i
                                        class="ri-building-line me-1 text-white-75 fs-16 align-middle"></i>{{ $sales->district->dis_name }}
                                </div>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <table class="table table-borderless mb-0">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-muted">{{ $sales->alamat . ', ' . $sales->district->dis_name.', '. $sales->city->city_name . ', '. $sales->province->prov_name }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th class="ps-0" scope="row">Tanggal bergabung :</th>
                                                                <td class="text-muted">{{ date("d-M-Y", strtotime($sales->created_at)) }}</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
