...
<div class="card">
  ...
  <div class="card-body">
    <div class="mb-1 row">
      ...
      <div class="col-sm-10">
        <h6 class="form-control-plaintext">: {{ strtoupper($jok->Order_detail->Order->sales_username) }}</h6>
      </div>
    </div>
    <div class="mb-1 row">
      <label for="staticEmail" class="col-sm-2 col-form-label">Nama Barang</label>
      <div class="col-sm-10">
        <h6 class="form-control-plaintext">: {{ strtoupper($jok->Order_detail->barang->nama) }}</h6>
      </div>
    </div>
    <div class="mb-2 row">
      <label for="inputPassword" class="col-sm-2 col-form-label">Jumlah</label>
      <div class="col-sm-10">
        <h6 class="form-control-plaintext">: {{ $jok->Order_detail->jumlah }}</h6>
      </div>
    </div>
